...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		echo '
		<div class="infodis">', $message['time'], '<span class="floatright"><strong>', !empty($message['counter']) ? $txt['reply_noun'] . ' #' . $message['counter'] : '', ' ', $txt['on'], '</strong></span></div>
				<div class="displaybg">
	...
	if ($context['user']['is_logged'] && $context['can_reply']) {
        if($context['num_replies'] == 0) {
	    echo '
		    <div class="dis_comment">'. $txt['rs_comments'] .'</div>';}
	}	
